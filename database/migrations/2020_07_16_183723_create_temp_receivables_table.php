...
class CreateTempReceivablesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('temp_receivables', function (Blueprint $table) {
            ...
            $table->string("ar_amt_typ")->nullable();
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('temp_receivables');
    }
}